    ...
    <main className={styles.root}>
        ...
        {restaurant.tags.length > 0 && (
          <ul className={styles.tags}>
            {restaurant.tags.map((tag) => (
              <li key={tag}>
                <Link
                  href={`/projects/fudi/search?category=${encodeURIComponent(tag)}`}
      ...
      {cartCount > 0 && (
        <div className={styles.cartBarWrap}>
          <Link href="/projects/fudi/cart" className={styles.cartBar} aria-label="Go to cart">
